...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val timeFrom0000ToTimeDepart = hoursDepart * 60 + minutesDepart
    val timeFrom0000ToTimeArrive = hoursArrive * 60 + minutesArrive
    return timeFrom0000ToTimeArrive - timeFrom0000ToTimeDepart
}
